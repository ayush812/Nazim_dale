...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([
        [ InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="https://t.me/mkvCinemastg_Bot")],[InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/skmovieslinks")],
        ...
        [ InlineKeyboardButton("🌐 Source Code", url="https://te.legra.ph/file/2184b7d4cd6fa1cfc8ac4.mp4")]
        ]
